...
function MapTab() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center gap-3 text-center px-8">
      ...
      <div>
        <p className="font-semibold text-gray-700">지도 탭</p>
...
function BudgetTab() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center gap-3 text-center px-8">
      ...
      <div>
        <p className="font-semibold text-gray-700">예산 탭</p>
        <p className="text-sm text-gray-400 mt-1">곧 출시 예정이에요</p>
      </div>
    </div>
  );
...
export default function App() {
  ...
  return (
    /*
     * 모바일 앱 컨테이너
     * 실제 기기에서는 전체 화면, 데스크톱 브라우저에서는 375px 카드로 보여줌
     */
    <div
      style={{
        minHeight: '100dvh',
    ...
    >
      <div
        style={{
          ...
          borderRadius: window.innerWidth > 480 ? '40px' : '0',
        }}
      >
        {/* 상단 앱 바 */}
        <AppBar />
        ...
        {/* 구분선 */}
        <div style={{ height: '1px', backgroundColor: '#f0f0ee', flexShrink: 0 }} />

        {/* 탭 콘텐츠 */}
        <div className="flex-1 flex flex-col overflow-hidden" style={{ backgroundColor: '#fafaf8' }}>
          {activeTab === 'schedule' && <DailyScheduleTab />}
